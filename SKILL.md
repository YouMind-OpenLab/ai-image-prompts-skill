...
| File | Category | Count |
|------|----------|-------|
| `profile-avatar.json` | Profile / Avatar | 1787 |
| `social-media-post.json` | Social Media Post | 9110 |
