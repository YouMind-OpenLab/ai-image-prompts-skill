...
| File | Category | Count |
|------|----------|-------|
| `profile-avatar.json` | Profile / Avatar | 2022 |
| `social-media-post.json` | Social Media Post | 9602 |
| `infographic-edu-visual.json` | Infographic / Edu Visual | 596 |
| `youtube-thumbnail.json` | YouTube Thumbnail | 218 |
| `comic-storyboard.json` | Comic / Storyboard | 661 |
| `product-marketing.json` | Product Marketing | 5600 |
