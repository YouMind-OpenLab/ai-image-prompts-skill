...
| File | Category | Count |
|------|----------|-------|
| `profile-avatar.json` | Profile / Avatar | 1772 |
| `social-media-post.json` | Social Media Post | 9083 |
