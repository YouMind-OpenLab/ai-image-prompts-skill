...
| File | Category | Count |
|------|----------|-------|
| `profile-avatar.json` | Profile / Avatar | 1273 |
| `social-media-post.json` | Social Media Post | 7687 |
...
| `product-marketing.json` | Product Marketing | 4534 |
| `ecommerce-main-image.json` | E-commerce Main Image | 493 |
