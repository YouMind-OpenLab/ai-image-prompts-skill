...
| File | Category | Count |
|------|----------|-------|
| `profile-avatar.json` | Profile / Avatar | 1279 |
| `social-media-post.json` | Social Media Post | 7717 |
...
| `product-marketing.json` | Product Marketing | 4557 |
...
| `others.json` | Uncategorized | 1035 |
