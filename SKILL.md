...
| File | Category | Count |
|------|----------|-------|
| `profile-avatar.json` | Profile / Avatar | 2088 |
| `social-media-post.json` | Social Media Post | 9711 |
